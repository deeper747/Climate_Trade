...
# install.packages("leaflet")   # if you don’t have it yet
...
wb_dw <- wb_clean %>%
  ...
  transmute(
    DW_NAME = country,                 # full country name
    VALUE   = round(export_pct, 1)     # exports (% of GDP), 1 decimal; remove round() if you prefer
  )
